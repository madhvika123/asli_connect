...
const AddLabBranch = ({ currentBranch, onClose, onSuccess }) => {
    ...
    useEffect(() => {
        if (currentBranch) {
            setLabBranchData({
                labcenterId: currentBranch.labcenterId || "",
                ...
                labVisitServiceAvailable: currentBranch.labVisitServiceAvailable !== undefined ? currentBranch.labVisitServiceAvailable : true
            });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Prepare lab center branch data according to API structure
            const labCenterBranchData = {
                ...
                logo: labBranchData.logo,
                image: labBranchData.image,
            ...
            if (labBranchData.latitude && labBranchData.longitude) {
                labCenterBranchData.location = {
                    type: "Point",
            ...
            if (!currentBranch) {
                ...
                // Add user location if coordinates are available
                if (labBranchUserData.userLatitude && labBranchUserData.userLongitude) {
                    labCenterBranchUserData.userLocation = {
                        type: "Point",
                        coordinates: [parseFloat(labBranchUserData.userLongitude), parseFloat(labBranchUserData.userLatitude)]
                    };
                }

                payload.labCenterBranchUserData = labCenterBranchUserData;
            }

            const endpoint = currentBranch 
                ? "/api/labCenter/update-lab-center-branch-by-lab" 
                : "/api/labCenter/create-lab-center-branch-by-lab";
