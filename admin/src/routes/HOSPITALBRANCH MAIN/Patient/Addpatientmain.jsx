...
const Addpatientmain = ({ patientDrawer,
    setPatientDrawer,
    fetchPatientsList,
    editId = null,
    setEditId, }) => {
    ...
    const onFinish = async (values) => {
        ...
        try {
            setLoading(true);
            const response = await postData("/api/branch/create-patient-for-branch", payload);
                            ...
                            <Col span={24}>
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: "Please enter patient email address",
                                        },
                                        {
                                            type: "email",
                                ...
                                >
                                    <TextField
                                        ...
                                        label={
                                            <div className='flex items-center'>
                                                <i className="ri-mail-line" style={{ marginRight: 8, fontSize: 20 }}></i>
                                                <div>Email *</div>
                                            </div>
                                        }
                                        size='small'
