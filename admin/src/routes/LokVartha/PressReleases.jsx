...
const PressReleases = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "mediaType",
      align: "center",
      render: (mediaType) => <span>{mediaType || "N/A"}</span>,
    },
    {
      title: "Publish Date",
...

    {
      ...
      align: "center",
      render: (content) => {
        // Use util helper to show truncated content with tooltip
        // Assuming you have TruncatedTextWithTooltip or createTruncatedTextRenderer imported
        // Show 30 character preview with tooltip for full content
  ...
  const fetchUserList = async () => {
    ...
    // Add filter (always PressRelease for this component)
    ...
    try {
      ...
      message.error(error?.message || "Failed to fetch press releases");
    } finally {
      setLoading(false);
    }
  };
