...
const HospitalBranchDoctors = () => {
  ...
  const fetchDoctorsList = async () => {
    ...
    try {
      setLoading(true);
      const response = await postData("api/hospital/list-of-doctors-by-hospital", payload);
  ...
  const fetchBranchesList = async () => {
    try {
      setLoading(true);
      const response = await postData("/api/hospital/list-of-branch-by-hospital");
      if (response?.responseCode == 200) {
...
export default HospitalBranchDoctors;
